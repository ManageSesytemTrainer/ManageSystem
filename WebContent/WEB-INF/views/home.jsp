...
<div class="row" style="height: 763px">
    <div class=" col-md-1" style="background-color:#69a6ff; height: inherit"></div>
    <div class=" col-md-10">
        <div class="row">
            <div class=" col-md-12">
                <!--标签-->
    ...
    <div class=" col-md-1" id="tui" >
        <a href="login2.html"><p style="text-align: center;color: #69a6ff ">退出<span class="glyphicon glyphicon-log-out" ></span></p>
        </a>
    </div>
</div>
